...
The analysis draws on Wave 1 of the UCNets dataset (University of California Network Study), collected in the San Francisco Bay Area in 2020. UCNets is an egocentric network dataset that provides detailed information on the composition, function, and structure of personal social networks, including demographic data, tie characteristics, and health-related variables. For this project, we focus on respondents (egos) who provided full information on their chronic health conditions, race, and the types of support they receive from their network alters. Ties are coded for presence of different support types—emotional, practical, social—as well as for characteristics such as ambivalence, reciprocity, and demand. The racial variable distinguishes White respondents from respondents of color to examine potential group-based disparities. 
